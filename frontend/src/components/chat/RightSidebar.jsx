...
// Mock shared media (placeholder images using colored blocks)
const MOCK_MEDIA = [
  { id: 1, color: '#5865f2' },
  { id: 2, color: '#eb459e' },
  { id: 3, color: '#00b4d8' },
...
export default function RightSidebar({ conversation, onClose }) {
  const [tab, setTab] = useState('info'); // 'info' | 'media' | 'files'

  if (!conversation) return null;

  const accentColor = getAvatarColor(conversation.name);
        ...
        <div style={{
          ...
          <div style={{ padding: '0 14px 14px', marginTop: -28 }}>
            ...
            <div style={{ marginTop: 10 }}>
              <div style={{ fontWeight: 800, fontSize: 16, color: 'var(--text-primary)', lineHeight: 1.2 }}>
                {conversation.name}
              </div>
              {conversation.type === 'dm' ? (
                <div style={{
                  fontSize: 12,
                  color: conversation.online ? '#3ba55c' : 'var(--text-muted)',
                  marginTop: 3,
                  fontWeight: 600,
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  <span style={{ width: 8, height: 8, borderRadius: '50%', background: conversation.online ? '#3ba55c' : '#80848e', display: 'inline-block', flexShrink: 0 }} />
            ...
            <div>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{
                  ...
                  <span style={{ width: 10, height: 10, borderRadius: '50%', background: conversation.online ? '#3ba55c' : '#80848e', display: 'inline-block', flexShrink: 0 }} />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <ActionButton icon={<MessageCircle size={15} />} label="Nhắn tin" variant="primary" />
