...
const messageSchema = new mongoose.Schema(
  {
    ...
    // ======== THÊM 2 TRƯỜNG NÀY ĐỂ XỬ LÝ TAG ========
    mentions: [{ type: mongoose.Schema.Types.ObjectId, ref: 'User' }], // Lưu ID của những người bị tag cụ thể
    mentionAll: { type: Boolean, default: false }, // Đánh dấu nếu dùng @all
