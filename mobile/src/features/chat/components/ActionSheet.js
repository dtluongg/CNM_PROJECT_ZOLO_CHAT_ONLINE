...
const ActionSheet = ({
  ...
  const actions = [
    ...
    },
    {
      ...
      action: 'revoke',
      danger: true,
      // Chỉ hiện với tin của mình chưa thu hồi và không phải bình chọn hay nhắc hẹn
      show: isMe && !isRevoked && msg.type !== 'poll' && msg.type !== 'reminder',
    },
    {
    ...
    <Modal visible={visible} transparent animationType="slide">
      <Pressable style={styles.sheetOverlay} onPress={onClose}>
        <View style={styles.sheet}>
          ...
          {/* Hàng emoji react (ẩn khi tin đã thu hồi hoặc là bình chọn hoặc nhắc hẹn) */}
          {!isRevoked && msg.type !== 'poll' && msg.type !== 'reminder' && (
